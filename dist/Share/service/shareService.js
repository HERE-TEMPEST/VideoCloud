...
var ShareService = /** @class */ (function () {
    ...
    ShareService.prototype.accessAll = function (userId, videoId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, serviceUser_1.ServiceUser.getAllUsers()];
                    case 1:
                        users = _a.sent();
                        users = users.filter(function (element) {
                            return element != userId;
                        });
                        return [4 /*yield*/, shareDB_1.shareDB.addAccess(users, videoId)];
                    case 2:
                        share = _a.sent();
                        if (!share) {
                            throw new Error_1.MyError('video not found', 404);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, shareDB_1.shareDB.addBan(users, videoId)];
                    case 2:
                        share = _a.sent();
                        return [2 /*return*/, share];
                }
