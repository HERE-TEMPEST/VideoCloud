...
var ShareService = /** @class */ (function () {
    ...
    ShareService.prototype.addAccess = function (usersId, videoId) {
        return __awaiter(this, void 0, void 0, function () {
            var isShare, newBanList, outData, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        newBanList = isShare.ban.filter(function (elem) {
                            var isUser = usersId.find(function (element) {
                                return element.equals(elem);
                            });
                            return !isUser;
                        });
                        share_model_1.ShareModel.updateOne({ videoId: videoId }, { ban: newBanList });
    ...
    ShareService.prototype.addBan = function (usersId, videoId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ShareService.prototype.addShare = function (userId, videoId, usersId) {
        return __awaiter(this, void 0, void 0, function () {
            var newShare, outData, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    ShareService.prototype.checkAccess = function (checkUser, videoId) {
        return __awaiter(this, void 0, void 0, function () {
            var isShare, isUser, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    ShareService.prototype.delShare = function (videoId) {
        return __awaiter(this, void 0, void 0, function () {
            var delShare, outData, error_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
...
exports.serviceShare = new ShareService();
