...
var VideoDB = /** @class */ (function () {
    ...
    VideoDB.prototype.addVideo = function (userId, file) {
    ...
    VideoDB.prototype.delVideo = function (userId, videoId) {
        return __awaiter(this, void 0, void 0, function () {
            var delFile, outputDate, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, schemaVideo_1.VideoModel.findOneAndDelete({ _id: videoId, userId: userId })];
                    case 1:
                        delFile = _a.sent();
                        if (!delFile) {
                            return [2 /*return*/, null];
    ...
    VideoDB.prototype.editVideo = function (userId, videoId, newname) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    VideoDB.prototype.getAllVideo = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    VideoDB.prototype.getVideo = function (userId, videoId) {
        return __awaiter(this, void 0, void 0, function () {
